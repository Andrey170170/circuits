#!/usr/bin/env python3
"""Build or strictly validate the process-witness near-10k qualification v1."""
...
from circuits.analysis.bonafide.process_witness_near_10k_qualification_v1 import (
...
def main() -> None:
    ...
    if args.command == "build":
        result = build_near_10k_qualification_v1(
            sampling_v2_root=args.sampling_v2_root,
            destination=args.destination,
            tokenizer=tokenizer,
        )
    else:
        result = load_frozen_near_10k_qualification_v1(args.root, tokenizer=tokenizer)[
            "manifest"
        ]
