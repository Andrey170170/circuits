#!/usr/bin/env python3
"""Build the globally sealed blind-review UI before v3 Batch reveal."""
...
def build(
    *,
    ...
    if (
        ...
        raise ValueError("coarse v3 review workstation binding drift")
    ...
    try:
        ...
        manifest = {
            ...
            "model_reveal_policy": "all 144 human decisions globally sealed first",
            "files": files,
        }
